"""
TsaiBakos_RST_M8_equivalentconditions.py
...
from HYPULSE_driver import HYPULSE_driver_equivalentconditions
...
driver_dict = {'driver_condition_name' :'HYPULSE test', 'driver_condition_type' : 'empirical-a4',
			   ...
			   'p4' : pe, 'a4' : ae, 'v4': 0.0, 'M_throat' : 0.0}

"""
TsaiBakos_Shot_69.py

Testing more HYPULSE GASL Shots

$ python3 TsaiBakos_Shot_69.py

Liam Heffernan 21/06/24
...
driver_fill_gas_name = '47-h2-23-o2-30-ar'
...
config_dict = {'mode':'fully_theoretical','output_filename':'TsaiBakos_Shot_69',

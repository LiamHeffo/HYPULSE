...
Modelling the M10 Nozzle AR 225 RST condition from 'Mach 7-21 Flight Simulation in the HYPULSE Shock Tunnel'. C.-Y. Tsai and R.J.
Bakos, 2002.

$ python3 TsaiBakos_RST_M10_225.py

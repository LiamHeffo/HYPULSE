"""
TsaiBakos_Shot_75.py

Testing more HYPULSE GASL Shots

$ python3 TsaiBakos_Shot_75.py

Liam Heffernan 13/01/24
...
driver_fill_gas_name = '233-h2-117-o2-65-ar'
...
p4_p100 = 19.72
		...
		# DETONATION DRIVER:
q100 = 'O2:11.7 H2:23.3 Ar:65'
p100 = p4/p4_p100 # Pa, this is the detonation driver pressure
T100 = 300 # K

# p400, a400, T400 = HYPULSE_driver_equivalentconditions(p4, T4, q4, p100, T100, q100)
...
config_dict = {'mode':'fully_theoretical','output_filename':'TsaiBakos_Shot_75',

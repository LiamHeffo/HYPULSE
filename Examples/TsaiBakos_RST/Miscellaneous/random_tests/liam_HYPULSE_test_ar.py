"""
liam_HYPULSE_test_ar.py

Doing some argon gas model testing too...

$ python3 liam_HYPULSE_test_ar.py
...
#driver_fill_gas_filename = 'cea-367-h2-183-o2-45-ar-gas-model.lua'
#driver_fill_gas_filename = 'cea-30-h2-15-o2-55-he-gas-model.lua'
#driver_fill_gas_filename  = 'cea-467-h2-233-o2-30-ar-gas-model.lua'

driver_gas_model = 'CEAGas-preset'
#driver_fill_gas_name = '30-h2-15-o2-55-he'
driver_fill_gas_name = '467-h2-233-o2-30-ar'
driver_fill_gas_name = '367-h2-183-o2-45-ar'
driver_fill_gas_name = '267-h2-133-o2-60-ar'

#facility_name = 'HYPULSE_rst_Mach_7_nozzle_area_ratio_175'

"""
liam_HYPULSE_test_6.py

Trying the equivalent pe and a3 here...

$ python3 liam_HYPULSE_test_6.py

Chris James (c.james4@uq.edu.au) - 03/11/23
...
driver_gas_model = 'custom'
#driver_fill_gas_filename = 'cea-267-h2-133-o2-60-ar-gas-model.lua'
#driver_fill_gas_filename = 'cea-30-h2-15-o2-55-he-gas-model.lua'
...
p4 = 34.0e6 # Pa, this is the helium driver condition (which drives the detonation, so we don't use that)

p100 = p4/30.1 # Pa, this is the detonation driver pressure

# state 400 seems to be the convention for post-detonation shock conditions
# these are now numbers where Liam has tried to model the driver correctly

#p400 = 11.83e6 # Pa
#T400 = 3325.20 # K
#v400 = 577.03 # m/s, this is the u2 lab frame value

# trying lower T400 and v400 as it is too fast
#T400 = 3000.0
#v400 = 400.0 # m/s

p1 = p4/223.0 # Pa
p5 = p1/999 # Pa, this is what they call p10 in the paper...

# equivalent driver conditions
pe = 16.51e6 # Pa
ae = 2020.27 # m/s

#Mthroat = 0 as I think HYPULSE has no area change?
...
driver_dict = {'driver_condition_name' :'HYPULSE test', 'driver_condition_type' : 'empirical-a4',
               ...
               'p4' : pe, 'a4' : ae, 'v4': 0.0, 'M_throat' : 0.0, 'T4_first_guess':2500.0}

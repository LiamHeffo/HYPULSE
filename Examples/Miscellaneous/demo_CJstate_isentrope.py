...
nfinal = i
P400 = P[nfinal] + u[nfinal]*(P[nfinal-1]-P[nfinal])/(u[nfinal-1]-u[nfinal])
a400 = a[nfinal]+ u[nfinal]*(a[nfinal-1]-a[nfinal])/(u[nfinal-1]-u[nfinal])
V400 = V[nfinal]+ u[nfinal]*(V[nfinal-1]-V[nfinal])/(u[nfinal-1]-u[nfinal])
T400 = T[nfinal]+ u[nfinal]*(T[nfinal-1]-T[nfinal])/(u[nfinal-1]-u[nfinal])
u400 = u[nfinal]

# State 400: 
print('State 400 ')
print(' Pressure %.2f (Pa)' % (P400) )
...
# I need to calculate temeprature, sound speed, volume etc.

"""
liam_HYPULSE_test_JF17.py

Trying to create some JF16 conditions from

Yuan et al. (2018) Spectral measurements of hypervelocity flow in an expansion tunnel

$ python3 liam_HYPULSE_test_JF16.py
...
from HYPULSE_driver import JF16_driver
from pitot3 import run_pitot3

driver_gas_model = 'CEAGas-preset'

driver_fill_gas_name = '75-h2-25-o2'

facility_name = 'x2_nozzle'

# Conditions from Table 1 of:
# Yuan, C. K., Zhou, K., Liu, Y. F., Hu, Z. M., & Jiang, Z. L. (2019).
# Spectral measurements of hypervelocity flow in an expansion tunnel.
# Acta Mechanica Sinica, 35, 24-31.
# https://doi.org/10.1007/s10409-018-0806-8

# but I guessed the driver numbers for now...

P100 = 1e6
T100 = 300
q100 = 'H2:75 O2:25'

p400, v400, a400, V400, T400, ae, pe = JF16_driver(P100, T100, q100)
...
driver_dict = {'driver_condition_name' :'JF16 test', 'driver_condition_type' : 'empirical-a4',
               'driver_gas_model' : driver_gas_model, 'driver_fill_gas_name' : driver_fill_gas_name,
			   'p4' : pe, 'a4' : ae, 'v4': 0, 'M_throat' : 0.0, 'T4_first_guess': 3500}

config_dict = {'mode':'fully_theoretical','output_filename':'JF16_test',

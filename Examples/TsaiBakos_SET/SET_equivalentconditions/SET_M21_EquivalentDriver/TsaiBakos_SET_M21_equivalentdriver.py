"""
TsaiBakos_SET_M15_equivalent_driver.py
...
from HYPULSE_driver import HYPULSE_driver_equivalentconditions, HYPULSE_driver_equivalentconditions
...
# pe, ae = HYPULSE_driver_equivalentconditions(p4, T4, q4, p100, T100, q100)
...
driver_dict = {'driver_condition_name' :'HYPULSE test', 'driver_condition_type' : 'empirical',
               ...
               'p4' : p400, 'T4' : T400, 'v4': 0.0, 'M_throat' : 0.0}
...
driver_dict = {'driver_condition_name' :'HYPULSE test', 'driver_condition_type' : 'empirical',
               'driver_gas_model' : driver_gas_model, 'driver_fill_gas_name' : driver_fill_gas_name,
               'p4' : p4CJ, 'T4' : T4CJ, 'v4': 0.0, 'M_throat' : 0.0}
